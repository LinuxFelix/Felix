...
iso=(release/'felix-1.0-x86.iso').stat().st_size
...
text=text.replace('HTTPS/OpenSSL and the C++ runtime are the largest individual runtime costs.', 'The terminal background extension requires Perl, and Imlib2 brings image-codec dependencies; these dominate the size cost. HTTPS/OpenSSL and the C++ runtime add further space.')
text=text.replace('has no DRM, wireless, WLAN, cfg80211 or mac80211', 'has no DRM. Wireless, cfg80211/mac80211, USB host controllers and selected Atheros, Ralink, Realtek and MediaTek drivers are enabled')
